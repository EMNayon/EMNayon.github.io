  ...
  return (
    <div name='home' className=' h-screen bg-[#0a192f] text-gray-300 pt-32'>
        <div className="max-w-[1000px] w-full md:grid grid-cols-12 gap-20 mx-auto">
          <div className="col-span-8 my-auto text-white">
              {/* <p className="text-2xl text-zinc-200 font-apparel">Hi, My name is</p> */}
          ...
          <div className="col-span-4 row-end-1 w-80 ">
            <img src={logo} alt="" className="duration-500 ease-in border border-pink-400 w-80 hover:scale-105 btnColor"/>  
          </div>  
        </div>  
    </div>
  );
