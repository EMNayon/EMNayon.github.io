    ...
    <div name='home' className=' h-screen bg-[#0a192f] text-gray-300 pt-32'>
        <div className="max-w-[1000px] w-full md:grid grid-cols-12 gap-20 mx-auto">
          <div className="col-span-8 text-white my-auto">
             ...
             <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&weight=900&size=40&pause=1000&vCenter=true&width=435&height=60&lines=EM+Nayon;Web+Developer" alt="Typing SVG" />
              <p className="text-[#8892b0] py-4 max-w-[700px] font-thin">Welcome to my portfolio, where expertise in web development meets creativity and innovation. I am an expert web developer with a passion for crafting remarkable user interfaces that leave a lasting impression.</p>
